...
function getImport(p, { id, source, nameHint }) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!p.hub.file[id]) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri May 04 2018 10:53:20 GMT+0000 (UTC)
</div>
</div>
